...
- (void)startMainFlow {
    ...
    UIViewController *upload = [SLocator.controllersFactory uploadFlowTab];
    ...
    [controller setControllerForNews:news forSend:send forWallet:wallet forProfile:profile forUpload:upload];
